						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">部门下员工信息</strong>
								</div>
								<table class="table">
									<thead>
									<tr>
									...
									<c:forEach items="${list }" var="list">
										<tr>
											...
											<td>${list.eIdnum }</td>
											<td>${list.jobNo }</td>
											<td>${list.eHiredate }</td>
											<td>${list.eType }</td>
										</tr>
									</c:forEach>
									</tbody>
								</table>
								<a href="<%=basePath%>DeptListController"/>
								<button class="btn btn-outline-secondary btn-lg active">返回</button>
							</div>
						</div>
