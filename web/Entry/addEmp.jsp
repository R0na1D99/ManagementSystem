            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="<%=basePath%>EmpServlet?method=add" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="jobno" name="jobno"
                                                                    value="${emp.empno}" class="form-control"><small
                                        class="form-text text-muted">设置员工ID</small></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="ename" name="ename"
                                        ...
                                        class="form-text text-muted" 设置员工姓名</small></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="epass" name="epass"
                                        ...
                                        class="form-text text-muted" 设置员工密码</small></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <small class="form-text text-muted">设置出生日期</small>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="eidnum" name="eidnum"
                                        ...
                                        class="form-text text-muted">设置身份证号</small></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <small class="form-text text-muted">设置入职日期</small>
                                </div>
                            </div>
