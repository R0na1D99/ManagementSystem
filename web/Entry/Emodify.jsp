            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="EmpServlet?method=Emodify" method="post" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="jobno" class=" form-control-label">员工号</label>
                                </div>
                                <div class="col-12 col-md-9"><input type="text" id="jobno" name="jobno"
                                                                    value="${emp.empno}" readonly="readonly"
                                                                    class="form-control"><small
                                        class="form-text text-muted">员工ID不可修改</small></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="ename" class=" form-control-label">员工姓名</label>
                                </div>
                                <div class="col-12 col-md-9"><input type="text" id="ename" name="ename"
                                                                    value="${emp.ename}" class="form-control"><small
                                        class="form-text text-muted">修改员工姓名</small></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="epass" class=" form-control-label">密码</label>
                                </div>
                                <div class="col-12 col-md-9"><input type="text" id="epass" name="epass"
                                                                    value="${emp.epass}" class="form-control"><small
                                        class="form-text text-muted">修改员工密码</small></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <small class="form-text text-muted">修改出生日期</small>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="esex" class="form-control" tabindex="1">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="eidnum" name="eidnum"
                                                                    value="${emp.eidnum}" class="form-control"><small
                                        class="form-text text-muted">修改身份证号</small></div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="estore" class=" form-control-label">人才库</label>
                                </div>
                                <div class="col-12 col-md-9"><input type="text" id="estore" name="estore"
                                                                    value="${emp.estore}" class="form-control"><small
                                        class="form-text  text-muted">修改人才库</small></div>
                            </div>
