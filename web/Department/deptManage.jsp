			...
			<nav class="navbar navbar-expand-sm navbar-default">
				...
				<div id="main-menu" class="main-menu collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li>
							<a href="index.jsp"><i class="menu-icon fa fa-laptop"></i>员工管理系统</a>
						</li>
						...
						<li class="menu-item-has-children dropdown">
	                        ...
	                        <ul class="sub-menu children dropdown-menu">
	                            ...
	                            <li><i class="fa fa-table"></i><a href="Department/addDept.jsp">新建部门</a></li>
	                        </ul>
	                    </li>
                    <li class="menu-item-has-children dropdown">
										...
										<tbody>
											<c:forEach items="${list }" var="list">
												<tr>
													...
													<td>${list.dBirth }</td>
													<td>
														<button type="button" class="btn btn-primary" onclick="deleteConfirm(${list.deptNo})"> 删除</button>
														<a href="<%=basePath%>UpdateController?deptNo=${list.deptNo }"><button type="button" class="btn btn-primary">修改</button>
