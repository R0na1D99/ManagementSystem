            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-bars"></i><a href="#">修改部门</a></li>
                        <li><i class="fa fa-id-card-o"></i><a href="#">删除部门</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-bars"></i><a href="#">修改岗位</a></li>
                        <li><i class="fa fa-id-card-o"></i><a href="#">删除岗位</a></li>
